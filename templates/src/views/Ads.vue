<template>
  ...
  <MDBContainer class="my-5 py-5">
    <h1 class="h3 text-center py-5 mb-0">Ads dashboard</h1>

    <!--Section: Mixed charts-->
          ...
          <MDBCard>
            ...
            <MDBCardBody>
              <div class="d-flex justify-content-around">
                ...
                <div>
                  <p class="mb-2">Avg. CPC</p>
                  <h5>
                    $0.3
                    <small class="text-success"
                      ><i class="fas fa-caret-down me-1"></i
                      ><span>-11.1%</span></small
                    >
                  </h5>
                </div>
                <div>
                  <p class="mb-2">Avg. CPM</p>
                  <h5>
                    $102.55
                    <small class="text-success"
                      ><i class="fas fa-caret-down me-1"></i
                      ><span>-13.4%</span></small
                    >
                  </h5>
                </div>
              </div>
    ...
    <section>
      <MDBCard>
        <MDBCardBody>
          <MDBDatatable :dataset="tableData" hover sm />
        </MDBCardBody>
      </MDBCard>
    </section>
    <!--Section: Table-->
...
export default {
  ...
  setup() {
    ...
    const acquisitionChartData = ref({
      labels: [
        "Monday",
        "Tuesday",
        "Wednesday",
