      ...
      <MDBCard>
        <MDBCardBody style="position: relative; overflow: hidden">
            ...
            >
              ...
              <div class="p-3">
                <MDBBtn color="primary" block>
                  <MDBIcon icon="plus" class="me-2"></MDBIcon>Compose
                </MDBBtn>
              </div>
              ...
              <MDBSideNavMenu>
                <MDBSideNavItem>
                  <MDBSideNavLink>
                    <MDBIcon icon="inbox" class="me-2 fa-fw"></MDBIcon
                    ><span>Inbox</span></MDBSideNavLink
                  >
                </MDBSideNavItem>
                <MDBSideNavItem>
                  <MDBSideNavLink>
                    <MDBIcon
                      icon="clock"
                      class="fas fa-clock me-2 fa-fw"
                    ></MDBIcon
                    ><span>Snoozed</span></MDBSideNavLink
                  >
                </MDBSideNavItem>
                <MDBSideNavItem>
                  <MDBSideNavLink
                    ><MDBIcon icon="paper-plane" class="me-2 fa-fw"></MDBIcon
                    ><span>Sent</span></MDBSideNavLink
                  >
                </MDBSideNavItem>
                <MDBSideNavItem>
                  <MDBSideNavLink>
                    <MDBIcon icon="file" class="me-2 fa-fw"></MDBIcon
                    ><span>Drafts</span></MDBSideNavLink
                  >
                </MDBSideNavItem>
                <MDBSideNavItem>
                  <MDBSideNavLink>
                    <MDBIcon icon="envelope" class="me-2 fa-fw"></MDBIcon
                    ><span>All mail</span></MDBSideNavLink
                  >
                </MDBSideNavItem>
                <MDBSideNavItem>
                  <MDBSideNavLink>
                    <MDBIcon icon="trash" class="me-2 fa-fw"></MDBIcon
                    ><span>Trash</span></MDBSideNavLink
                  >
                </MDBSideNavItem>
                <MDBSideNavItem>
                  <MDBSideNavLink>
                    <MDBIcon icon="exclamation" class="me-2 fa-fw"></MDBIcon
                    ><span>Spam</span></MDBSideNavLink
                  >
                </MDBSideNavItem>
              </MDBSideNavMenu>
          ...
          <section id="message-input" class="fixed-bottom card bg-light">
            <MDBCardBody>
              <form class="d-flex">
                <MDBBtn color="primary" class="px-3">
...
export default {
  ...
  setup() {
    ...
    return { innerSidenav, side, over, search, textarea, tableData };
  },
};
</script>
